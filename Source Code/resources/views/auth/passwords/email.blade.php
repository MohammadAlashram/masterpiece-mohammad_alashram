                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">{{ __('Send Password Reset Link') }}
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="order-1 order-lg-2 flex-column-auto flex-lg-row-fluid d-flex flex-column p-7"
                ...
                <div class="d-flex flex-column-fluid flex-lg-center">
                    <div class="d-flex flex-column justify-content-center">
                        <h3 class="display-4 font-weight-bold my-7 text-white">Don't Worry
                            <br />You Can<span style="color: #FF6600"> Rest </span><br />Your Password Easily
                        </h3>
